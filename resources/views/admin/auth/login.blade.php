                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="{{ route('adminlogin') }}">
                        ...
                        <div class="form-group{{ $errors->has('agentname') ? ' has-error' : '' }}">
                            <label for="agentname" class="col-md-4 control-label">管理员账号</label>

                            <div class="col-md-6">
                                <input id="agentname" type="agentname" class="form-control" name="agentname" value="{{ old('agentname') }}" required autofocus>

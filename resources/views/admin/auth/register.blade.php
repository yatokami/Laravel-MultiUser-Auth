                ...
                <div class="panel-body">
                    <form class="form-horizontal" method="POST" action="/admin/register">
                        ...
                        <div class="form-group{{ $errors->has('agentname') ? ' has-error' : '' }}">
                            <label for="agentname" class="col-md-4 control-label">用户名</label>

                            <div class="col-md-6">
                                <input id="agentname" type="text" class="form-control" name="agentname" value="{{ old('agentname') }}" required autofocus>
